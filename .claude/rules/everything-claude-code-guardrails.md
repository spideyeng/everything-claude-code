...
- add-new-agent-command: Adds documentation or configuration for a new agent command to the system.
- add-new-skill-command: Adds documentation or configuration for a new skill command to the system.
