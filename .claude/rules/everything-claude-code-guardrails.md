...
- add-new-agent-command: Adds a new agent command to the ECC bundle, documenting the process for creating a new agent.
- add-new-skill-command: Adds a new skill command to the ECC bundle, documenting the process for creating a new skill.
